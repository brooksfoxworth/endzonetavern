...
class PageManager {
    ...
    /**
     * Render the header with a single centered logo
     */
    renderHeader() {
        const headerHTML = `
                ...
                <nav class="mb-8">
                    <div class="overflow-x-auto">
                        <div class="flex space-x-4 border-b border-[var(--border-color)] min-w-max px-4">
                            <a href="#Pizza" class="px-3 py-2 border-b-2 border-b-[var(--primary-color)] text-[var(--text-dark)] font-bold whitespace-nowrap">Pizza</a>
                            <a href="#Wings & Chicken" class="px-3 py-2 border-b-2 border-b-transparent text-[var(--text-medium)] font-medium hover:text-[var(--text-dark)] whitespace-nowrap">Wings & Chicken</a>
                            <a href="#Appetizers" class="px-3 py-2 border-b-2 border-b-transparent text-[var(--text-medium)] font-medium hover:text-[var(--text-dark)] whitespace-nowrap">Appetizers</a>
                            <a href="#Sides" class="px-3 py-2 border-b-2 border-b-transparent text-[var(--text-medium)] font-medium hover:text-[var(--text-dark)] whitespace-nowrap">Sides</a>
